...
<?php
require "../../directory/PHPMailer-master/PHPMailerAutoload.php";
$errors = [];
$errorMessage = '';
...
if (!empty($_POST)) {
   ...
   if (!empty($errors)) {
       ...
       $mail->Password = 'unql psmc dygz xjbk';
       ...
       if($mail->send()){
           header('Location: thankYou.php'); // Redirect to 'thank you' page. Make sure you have it
       } else {
