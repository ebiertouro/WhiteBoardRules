...
$query = "SELECT students.student_id, first_name, last_name, birthday FROM students join student_subject on students.student_id = student_subject.student_id WHERE subject_id=" . $_GET['subject_id'];

$currentStudents = $connection->query($query);

// Query to retrieve students from the database
$query = "SELECT DISTINCT students.student_id, first_name, last_name, birthday FROM students LEFT OUTER JOIN student_subject ON students.student_id = student_subject.student_id WHERE students.student_id NOT IN( SELECT student_id FROM student_subject WHERE subject_id = " . $_GET['subject_id'] . " );";
